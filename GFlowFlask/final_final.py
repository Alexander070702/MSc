...
def check_lost(positions):
    # Modified to check if any position at the top row is occupied
...
def calculate_reward(rows_cleared, grid, current_height, invalid_moves=0):
    height_penalty = current_height ** 2
    hole_penalty = 0
    ...
    row_reward = rows_cleared * 100
    return row_reward - height_penalty - hole_penalty - invalid_moves * 5 + 1
...
class ReplayBuffer:
    ...
    def add(self, experience, priority=None):
        # If priority-based experience replay isn't required, ignore priority.
...
def display_info_panel(surface, score, reward, action_probs, flows):
    ...
    # Display agent behavior guidelines with adjusted spacing
    info_text = [
        "Agent Behavior",
    ...
    for i, line in enumerate(info_text):
        ...
        surface.blit(info_label, (SCREEN_WIDTH + 10, 90 + i * 25))  # Adjusted spacing
...
class FlowManager:
    def __init__(self):
        # Initialize with equal probability flows for left, right, rotate, and down actions
